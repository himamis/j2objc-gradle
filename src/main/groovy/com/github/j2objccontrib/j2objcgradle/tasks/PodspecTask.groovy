...
class PodspecTask extends DefaultTask {
    ...
    @Input
    boolean getIncludePodspecResources() {
        return J2objcConfig.from(project).podspecIncludeResources;
    }
    ...
    void podspecWrite() {
        ...
        String headerIncludePath = Utils.relativizeNonParent(xcodeProjectDirFile.absoluteFile, getDestSrcMainObjDirFile())
        String j2objcHome = Utils.relativizeNonParent(xcodeProjectDirFile.absoluteFile, new File(getJ2objcHome()))
        ...
        String podspecContentsDebug =
                genPodspec(getPodNameDebug(), headerIncludePath, resourceIncludePath,
                        ...
                        getLibName(), j2objcHome, getIncludePodspecResources())
    ...
    static String genPodspec(String podname, String publicHeadersDir, String resourceDir,
        ...
        //validatePodspecPath(j2objcHome, true)
        ...
        return "Pod::Spec.new do |spec|\n" +
               ...
               "  spec.summary = 'Generated by the J2ObjC Gradle Plugin.'\n" +
                (includeResources ? "  spec.resources = '$resourceDir/**/*'\n" : "") +
